...
## Annotating eQTL
All significant eQTL are annotated with their distance to the different histone marks as well
as functional categories infered from the presence of different marks.
